# Stage 4: Railway Deploy

**Last verified: 2026-05-08.** Re-verify before this stage if older than 60 days. Search: `Railway MCP server <year>`, `Railway CLI documentation`. Read the official docs at `docs.railway.com/ai/remote-mcp-server` and `docs.railway.com/cli/login`.
