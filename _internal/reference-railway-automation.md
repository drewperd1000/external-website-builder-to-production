...
**Last verified: 2026-05-08** against `docs.railway.com/ai/mcp-server`, `docs.railway.com/cli`, and `docs.railway.com/reference/cli-api`. Re-verify if older than 60 days.
