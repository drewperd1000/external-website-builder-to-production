...
> **🤖 Re-grounding (re-read at start)**: This is a Claude-driven skill. I (Claude) execute the work; the user provides decisions and a small number of inputs. Onboarding's job is to figure out (1) how the user wants to work with me and (2) the minimum information I need to start. I do NOT make the user do technical setup during onboarding unless they explicitly want to.
